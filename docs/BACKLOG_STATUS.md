...
| DOC-032 | Normalize cross-scenario tab/field aesthetics and logical grouping to IBM Cloud IPI quality bar (merged with COMP Phase 7 Uniformity Audit) | active | p2 | user backlog intake (2026-03-24), `docs/DESIGN_SYSTEM.md`, `COMPREHENSIVE_MASTER_PLAN.md` Phase 7 | step UIs under `frontend/src/steps/` | Define reusable layout contract, audit typography/spacing/layout consistency across all scenarios, and apply normalization. **Deferred to later phases** after field-related tasks complete. Merged with COMP Phase 7 (uniformity & consistency audit) for comprehensive approach: audit + normalize together. |
