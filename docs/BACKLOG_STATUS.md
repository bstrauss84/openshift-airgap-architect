...
| DOC-050 | UI Field Width & Layout Standardization | done_pending_verification | p2 | `UI_STANDARDIZATION_STATUS.md`, `TOOLTIP_COMPLETION_2026-05-10.md` | Commits d947858, 9c4c067, 5c7b68f, 38260dd; `frontend/src/styles.css` (.credentials-field-constrained 700px→875px, 25% expansion), `frontend/src/components/OptionRow.jsx` (style/className props), `frontend/src/steps/OperatorsStep.jsx` (Fast mode margin fix) | Credentials field width expanded 25% (SSH keys, pull secrets across Identity & Access, Operators, Run oc-mirror tabs). OptionRow component enhanced for styling flexibility. Verify AWS GovCloud and IBM Cloud field standardization deferred items remain tracked in LOCAL_BACKLOG. |
