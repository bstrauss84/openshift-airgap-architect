...
| DOC-063 | Expand Operator scenario quick picks with subscription-based presets | active | p2 | user backlog intake (2026-05-10), `LOCAL_BACKLOG.md` #6 | `frontend/src/steps/OperatorsStep.jsx`, operator quick pick definitions | **Current:** Basic quick picks exist. **Goal:** Add more scenario quick picks matching OpenShift subscription types and common patterns. **Examples:** (1) **OpenShift Platform Plus:** Include all relevant operators for Platform Plus subscription. (2) **App Development Suite:** Include operators for app dev workflows. (3) Other common subscription/use-case bundles. **Cross-reference:** LOCAL_BACKLOG.md #6 explores operator dependency automation; this item focuses on expanding curated quick pick scenarios. |
