/**
 * OpenShift Airgap Architect - Field Guide Assembler
 *
 * Compartment selection, ordering, and Field Guide rendering.
 * Selects version-specific compartments and assembles the final guide markdown.
 *
 * @author Bill Strauss
 *
...
const renderGuide = (state, ctx, docsLinks) => {
  ...
  lines.push("---");
  lines.push("");
  lines.push("*Generated by [OpenShift Airgap Architect](https://github.com/billstrauss/openshift-airgap-architect) • Developed by Bill Strauss with AI assistance from Claude (Anthropic) and Cursor AI*");
  lines.push("");
