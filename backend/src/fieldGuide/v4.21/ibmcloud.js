...
export const ibmCloudIpiPrereqs = {
  ...
  docRefs: [
    {
      label: "Installing on IBM Cloud (OCP 4.21)",
      url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing_on_ibm_cloud/index"
    },
    {
      label: "Installing on IBM Cloud in a disconnected environment",
      url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing_on_ibm_cloud/installing-ibm-cloud-restricted"
    }
  ],
  items: [
    { text: "Confirm installer-provisioned IBM Cloud install method (UPI is not supported for this platform in OCP 4.21)." },
