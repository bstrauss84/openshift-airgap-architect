...
export const awsGovCloudPrereqs = {
  ...
  docRefs: [
    { label: "Installing a cluster on AWS (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-on-aws" },
    { label: "AWS GovCloud — disconnected install", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-on-aws#installing-restricted-networks-aws-installer-provisioned" },
    { label: "AWS IPI install-config reference", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-on-aws#installation-aws-config-yaml_installing-aws" },
  ],
  items: [
...
export const awsGovCloudInstall = {
  ...
  docRefs: [
    { label: "Installing a cluster on AWS — create cluster (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-on-aws#installing-aws" },
  ],
  items: [
...
export const awsGovCloudUpiPrereqs = {
  ...
  docRefs: [
    { label: "Installing a cluster on AWS with UPI (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-on-aws#installing-aws-user-infra" },
  ],
  items: [
...
export const awsGovCloudUpiInstall = {
  ...
  docRefs: [
    { label: "AWS UPI — cluster installation steps (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-on-aws#installation-aws-user-infra-installation_installing-aws-user-infra" },
  ],
  items: [
