...
export const globalPrereqs = {
  ...
  items: [
    ...
    { text: "Review the release notes for OCP {{version}} for any known issues or prerequisites specific to this patch:", cmd: "# https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/release_notes/index" },
  ],
};
...
export const proxyConfig = {
  ...
  docRefs: [
    { label: "Configuring a proxy during installation (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-with-a-proxy" },
  ],
  items: [
...
export const fipsPrereqs = {
  ...
  docRefs: [
    { label: "Support for FIPS cryptography in OCP 4.21", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-fips-validated-modules" },
...
export const ntpConfig = {
  ...
  docRefs: [
    { label: "Configuring chrony time service for OCP nodes", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/post-installation_configuration/post-install-machine-configuration-tasks#nodes-nodes-working-setting-timeouts-for-termination_post-install-machine-configuration-tasks" },
  ],
  items: [
...
export const trustBundle = {
  ...
  docRefs: [
    { label: "Configuring a custom PKI / additionalTrustBundle (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-disconnected-environments#installation-configure-proxy_installing-disconnected-environments" },
  ],
  items: [
...
export const toolsAndCreds = {
  ...
  conditions: {},
  docRefs: [
    { label: "Downloading OpenShift CLI tools", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/cli_tools/openshift-cli-oc#cli-getting-started" },
    { label: "oc-mirror v2 overview", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/disconnected_installation_mirroring/mirroring-images-disconnected-install-oc-mirror-v2" },
  ],
  items: [
...
export const postInstallValidation = {
  ...
  conditions: {},
  docRefs: [
    { label: "Verifying node health (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/nodes/working-with-nodes" },
    { label: "Understanding cluster operators", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/operators/understanding-operators" },
  ],
  items: [
...
export const day2Basics = {
  ...
  conditions: {},
  docRefs: [
    { label: "Post-installation configuration (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/post-installation_configuration/index" },
    { label: "Managing user workloads and RBAC", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/authentication_and_authorization/index" },
  ],
  items: [
