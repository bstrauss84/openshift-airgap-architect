...
export const bmAgentPrereqs = {
  ...
  docRefs: [
    { label: "Agent-based Installer on bare metal (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-with-agent-based-installer" },
    { label: "Agent-based Installer — preparing the agent-config.yaml", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-with-agent-based-installer#agent-config-yaml-reference" },
  ],
  items: [
...
export const bmAgentInstall = {
  ...
  docRefs: [
    { label: "Agent-based Installer — creating and booting the cluster (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-with-agent-based-installer#installing-ocp-agent_installing-with-agent-based-installer" },
  ],
  items: [
...
export const bmIpiPrereqs = {
  ...
  docRefs: [
    { label: "Installing a cluster on bare metal with IPI (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-on-bare-metal#installing-bare-metal-network-requirements_installing-bare-metal" },
    { label: "Bare metal IPI — configuring host inventory", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-on-bare-metal#configuring-host-inventory_installing-bare-metal" },
  ],
  items: [
...
export const bmIpiInstall = {
  ...
  docRefs: [
    { label: "Installing cluster on bare metal IPI — cluster creation (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-on-bare-metal#installing-bare-metal" },
  ],
  items: [
...
export const bmUpiPrereqs = {
  ...
  docRefs: [
    { label: "Installing a cluster on bare metal with UPI (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-on-bare-metal#installing-bare-metal-upi" },
  ],
  items: [
...
export const bmUpiInstall = {
  ...
  docRefs: [
    { label: "Bare metal UPI — cluster creation steps (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-on-bare-metal#installing-bare-metal-upi" },
  ],
  items: [
