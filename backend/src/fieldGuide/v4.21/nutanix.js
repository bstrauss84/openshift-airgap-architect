...
export const nutanixIpiPrereqs = {
  ...
  docRefs: [
    { label: "Installing a cluster on Nutanix (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-on-nutanix" },
    { label: "Nutanix IPI install-config reference (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-on-nutanix#installation-nutanix-config-yaml_installing-nutanix" },
  ],
  items: [
    { text: "Confirm Nutanix AOS version is 6.5.2.7 or later and Prism Central is pc.2022.6 or later. Verify from Prism Central UI or API:", cmd: "curl -sk https://{{nutanixEndpoint}}:9440/api/nutanix/v3/clusters/list \\\n  -X POST -H 'Content-Type: application/json' \\\n  -d '{\"kind\":\"cluster\"}' | python3 -m json.tool | grep 'software_version'" },
...
export const nutanixIpiInstall = {
  ...
  docRefs: [
    { label: "Installing a cluster on Nutanix — cluster creation (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-on-nutanix#installing-nutanix" },
  ],
  items: [
