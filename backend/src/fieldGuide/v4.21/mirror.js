...
export const mirrorRegistrySetup = {
  ...
  docRefs: [
    { label: "mirror-registry for Red Hat OpenShift (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/disconnected_installation_mirroring/installing-mirroring-installation-images" },
    { label: "Using the mirror registry for disconnected installations", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/disconnected_installation_mirroring/installing-mirroring-disconnected-v2" },
  ],
  items: [
...
export const ocMirrorLowSide = {
  ...
  docRefs: [
    { label: "oc-mirror v2: mirroring to disk", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/disconnected_installation_mirroring/mirroring-images-disconnected-install-oc-mirror-v2#oc-mirror-creating-mirror-to-disk_oc-mirror-v2" },
    { label: "ImageSetConfiguration reference (v2)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/disconnected_installation_mirroring/mirroring-images-disconnected-install-oc-mirror-v2#oc-mirror-v2-imageset-config-ref" },
  ],
  items: [
...
export const airGapTransfer = {
  ...
  docRefs: [
    { label: "Preparing for a disconnected install (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/disconnected_installation_mirroring/index" },
  ],
  items: [
...
export const ocMirrorHighSide = {
  ...
  conditions: { when: (ctx) => ctx.usingMirrorRegistry && ctx.connectivity === "fully-disconnected" },
  docRefs: [
    { label: "oc-mirror v2: mirroring from disk to registry", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/disconnected_installation_mirroring/mirroring-images-disconnected-install-oc-mirror-v2#oc-mirror-disk-to-mirror_oc-mirror-v2" },
  ],
  items: [
...
export const clusterResourcesApply = {
  ...
  conditions: { when: (ctx) => ctx.usingMirrorRegistry },
  docRefs: [
    { label: "Applying cluster resources after mirroring (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/disconnected_installation_mirroring/mirroring-images-disconnected-install-oc-mirror-v2#oc-mirror-v2-apply-cluster-resources" },
  ],
  items: [
