...
export const azureGovPrereqs = {
  ...
  docRefs: [
    { label: "Installing a cluster on Azure Government (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-on-azure" },
    { label: "Azure install-config reference (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-on-azure#installation-azure-config-yaml_installing-azure" },
  ],
  items: [
...
export const azureGovInstall = {
  ...
  docRefs: [
    { label: "Installing a cluster on Azure — create cluster (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-on-azure#installing-azure" },
  ],
  items: [
...
export const azureGovUpiPrereqs = {
  ...
  docRefs: [
    { label: "Installing a cluster on Azure with UPI (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-on-azure#installing-azure-user-infra" },
  ],
  items: [
...
export const azureGovUpiInstall = {
  ...
  docRefs: [
    { label: "Azure UPI — cluster installation steps (OCP 4.21)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/installing/installing-on-azure#installation-azure-user-infra-installation_installing-azure-user-infra" },
  ],
  items: [
