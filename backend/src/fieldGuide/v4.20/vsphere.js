...
export const vsphereAgentMethodologyContext = {
  ...
  docRefs: [
    { label: "Installing in disconnected environments (OCP 4.20)", url: "https://docs.redhat.com/en/documentation/openshift_container_platform/4.20/html/installing/installing-disconnected-environments" },
  ],
  items: [
